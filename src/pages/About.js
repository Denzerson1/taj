...
const AboutPage = () => {
    return (
        <div className="relative min-h-screen font-mukta text-gray-900">
            ...
            <div className="relative pt-32 pb-20 px-4 lg:px-24 text-center bg-gradient-to-b from-gray-700 to-[#B2B2B2] text-gray-100">
                <h1 className="text-5xl md:text-6xl font-bold mb-6">
                    Discover the Essence of India in the Heart of Vienna
                </h1>
                <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
                    Step into a world where tradition meets elegance. At Taj Vienna, we invite you to embark on a culinary journey through the vibrant landscapes of India, reimagined for the refined tastes of our discerning guests.
                </p>
            </div>

            {/* Main Content Section */}
            <div className="bg-[#B2B2B2] text-gray-800 py-16 px-4 lg:px-24">
                <div className="max-w-5xl mx-auto grid gap-12 md:grid-cols-2">
                    ...
                    <div className="relative">
                        ...
                        />
                        <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-gray-600 to-transparent"></div>
                    </div>
                </div>
            </div>

            {/* Mission & Vision Section */}
            <div className="bg-gray-700 py-20 px-4 lg:px-24 text-gray-100">
            ...
            {/* Experience Section */}
            <div className="bg-[#B2B2B2] py-20 px-4 lg:px-24">
                <div className="max-w-5xl mx-auto grid gap-12 md:grid-cols-2 items-center">
                    ...
                    <div className="relative">
                        <img
                            ...
                            className="w-full h-full object-cover rounded-lg shadow-lg"
                        />
                        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-gray-600 to-transparent"></div>
                    </div>
            ...
            {/* Final CTA Section */}
            <div className="bg-gradient-to-b from-[#B2B2B2] to-gray-600 py-20 px-4 lg:px-24 text-center text-gray-100">
                ...
                <a
                    ...
                    className="inline-block bg-[#FFD700] text-gray-900 font-semibold py-3 px-8 rounded-lg shadow-lg transition duration-300 hover:bg-[#e6c200]"
                >
                    Book a Table
                </a>
            </div>
